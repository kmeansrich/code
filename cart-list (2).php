...
<table id="order-table">
  ...
  <tbody>
    <?php
      ...
      $db_host = "localhost";
      $db_user = "myphotoin2090";
      $db_pass = "my@photo321";
      $db_name = "joon_myphotoprint";
...
<script>
  ...
  $(document).on("click", "#export-btn", function() {
    ...
    var workbook = XLSX.utils.book
    // Add the column names to the worksheet
    var worksheet = XLSX.utils.table_to_sheet($("#order-table")[0]);
    XLSX.utils.sheet_add_aoa(worksheet, [["Name", "Mobile No", "Product Name / Quantity", "Attribute", "Created", "Action"]], { origin: "A1" });

    // Set the worksheet name
    var sheetName = "Orders " + startDate + " to " + endDate;
